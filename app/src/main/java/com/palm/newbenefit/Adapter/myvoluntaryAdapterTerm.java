...
public class myvoluntaryAdapterTerm extends RecyclerView.Adapter<myvoluntaryAdapterTerm.ViewHolder> {
    Constants con;
    private List<VoluntaryBenefit> mTrain;
    private Context context = null;
    String token,policy_id;
    // Pass in the contact array into the constructor
    public myvoluntaryAdapterTerm(Context context, List<VoluntaryBenefit> train) {
