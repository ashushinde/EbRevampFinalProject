...
public class myvoluntaryAdapterGroup extends RecyclerView.Adapter<myvoluntaryAdapterGroup.ViewHolder> {
    Constants con;
    private List<VoluntaryBenefit> mTrain;
    private Context context = null;
    String token,policy_id;
    // Pass in the contact array into the constructor
    public myvoluntaryAdapterGroup(Context context, List<VoluntaryBenefit> train) {
