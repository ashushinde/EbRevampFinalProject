...
public class myvoluntaryAdapterPersonal extends RecyclerView.Adapter<myvoluntaryAdapterPersonal.ViewHolder> {
    Constants con;
    private List<VoluntaryBenefit> mTrain;
    private Context context = null;
    String token,policy_id;
    // Pass in the contact array into the constructor
    public myvoluntaryAdapterPersonal(Context context, List<VoluntaryBenefit> train) {
