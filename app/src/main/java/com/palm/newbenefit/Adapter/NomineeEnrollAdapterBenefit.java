...
public class NomineeEnrollAdapterBenefit extends RecyclerView.Adapter<NomineeEnrollAdapterBenefit.ViewHolder> {
    Constants con;
    ...
    public NomineeEnrollAdapterBenefit(Context context, List<NomineeEnroll> train, String emp_id) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View trainingView = inflater.inflate(R.layout.nominee_enroll_list_benefit, parent, false);
