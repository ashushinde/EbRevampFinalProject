...
public class InrollmentAdapterTabAdapterWithoutAddwithnominee extends FragmentStatePagerAdapter {
    int tabCount;


    Bundle bundle;

    public InrollmentAdapterTabAdapterWithoutAddwithnominee(FragmentManager fm, int tabCount) {
        super(fm);
