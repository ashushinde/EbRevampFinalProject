...
public class InrollmentAdapterTabAdapterWithoutAddnominee extends FragmentStatePagerAdapter {
    int tabCount;


    Bundle bundle;

    public InrollmentAdapterTabAdapterWithoutAddnominee(FragmentManager fm, int tabCount) {
        super(fm);
