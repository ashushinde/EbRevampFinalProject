...
public class myvoluntaryAdapterGroupMyTerm extends RecyclerView.Adapter<myvoluntaryAdapterGroupMyTerm.ViewHolder> {
    Constants con;
    private List<VoluntaryBenefit> mTrain;
    private Context context = null;
    String token,policy_id;
    // Pass in the contact array into the constructor
    public myvoluntaryAdapterGroupMyTerm(Context context, List<VoluntaryBenefit> train) {
