...
public class myvoluntaryAdapterVolTermSumm extends RecyclerView.Adapter<myvoluntaryAdapterVolTermSumm.ViewHolder> {
    Constants con;
    ...
    public myvoluntaryAdapterVolTermSumm(Context context, List<VoluntaryBenefit> train) {
