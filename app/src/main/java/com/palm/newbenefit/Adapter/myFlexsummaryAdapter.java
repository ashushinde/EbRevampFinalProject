...
public class myFlexsummaryAdapter extends RecyclerView.Adapter<myFlexsummaryAdapter.ViewHolder> {
    Constants con;
    private List<FlexBenefit> mTrain;
    private Context context = null;

    // Pass in the contact array into the constructor
    public myFlexsummaryAdapter(Context context, List<FlexBenefit> train) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View trainingView = inflater.inflate(R.layout.wellnes_list, parent, false);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        con = new Constants();
            ...
            viewHolder.flex_name.setText(train.getName());
        viewHolder.flex_discription.setText(train.getFlex_name());
