...
public class myvoluntaryAdapterMediclaimSumm extends RecyclerView.Adapter<myvoluntaryAdapterMediclaimSumm.ViewHolder> {
    Constants con;
    ...
    public myvoluntaryAdapterMediclaimSumm(Context context, List<VoluntaryBenefit> train) {
