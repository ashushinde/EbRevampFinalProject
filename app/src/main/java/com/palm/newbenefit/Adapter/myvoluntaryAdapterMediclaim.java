...
public class myvoluntaryAdapterMediclaim extends RecyclerView.Adapter<myvoluntaryAdapterMediclaim.ViewHolder> {
    Constants con;
    private List<VoluntaryBenefit> mTrain;
    private Context context = null;
    String token,policy_id;
    // Pass in the contact array into the constructor
    public myvoluntaryAdapterMediclaim(Context context, List<VoluntaryBenefit> train) {
