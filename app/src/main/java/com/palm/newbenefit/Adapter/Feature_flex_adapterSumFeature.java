...
public class Feature_flex_adapterSumFeature extends RecyclerView.Adapter<Feature_flex_adapterSumFeature.ViewHolder> {
    Constants con;
    ...
    public Feature_flex_adapterSumFeature(Context context, List<MyInsuranceFlex> train) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View trainingView = inflater.inflate(R.layout.feature_list_flex, parent, false);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        con = new Constants();
          ...
          viewHolder.ben_name.setText(train.getDescription());
...
/*
        ...
        GridLayoutManager policy_cycle_termterm = new GridLayoutManager(context, 1, GridLayoutManager.VERTICAL, false);
...
*/
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(final Context context, View itemView) {
            ...
            super(itemView);
            ben_name = (TextView) itemView.findViewById(R.id.ben_name);
