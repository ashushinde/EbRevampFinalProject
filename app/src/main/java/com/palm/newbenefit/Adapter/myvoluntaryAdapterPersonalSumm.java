...
public class myvoluntaryAdapterPersonalSumm extends RecyclerView.Adapter<myvoluntaryAdapterPersonalSumm.ViewHolder> {
    Constants con;
    ...
    public myvoluntaryAdapterPersonalSumm(Context context, List<VoluntaryBenefit> train) {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            Log.e("gpanominee", data.toString());
