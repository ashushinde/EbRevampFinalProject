...
public class GroupCoverMemberAdapterSepRel extends RecyclerView.Adapter<GroupCoverMemberAdapterSepRel.ViewHolder> {
    ...
    public GroupCoverMemberAdapterSepRel(Context context, List<VoluntaryBenefit> groupCoverMemberLists) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.member_list_summary_rel, parent, false);
