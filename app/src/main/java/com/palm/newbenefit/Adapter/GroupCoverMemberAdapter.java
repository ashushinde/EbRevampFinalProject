...
public class GroupCoverMemberAdapter extends RecyclerView.Adapter<GroupCoverMemberAdapter.ViewHolder> {
    ...
    public GroupCoverMemberAdapter(Context context, List<VoluntaryBenefit> groupCoverMemberLists) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.member_list_summary, parent, false);
