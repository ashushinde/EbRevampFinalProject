...
public class GroupCoverMemberAdapterSepSum extends RecyclerView.Adapter<GroupCoverMemberAdapterSepSum.ViewHolder> {
    ...
    public GroupCoverMemberAdapterSepSum(Context context, List<VoluntaryBenefit> groupCoverMemberLists) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.member_list_summary_sum, parent, false);
