...
public class sepreaterecycleadapter extends RecyclerView.Adapter<sepreaterecycleadapter.ViewHolder> {
    Constants con;
    ...
    public sepreaterecycleadapter(Context context, List<VoluntaryBenefit> train) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View trainingView = inflater.inflate(R.layout.policy_list_summary_sep, parent, false);
...
//                                            String cover_data = NumberFormat.getNumberInstance(Locale.US).format(datas);
                    ...
                    if(allPremiumdata.equalsIgnoreCase("0.0")
                        ...
                        for (int i=0;i<jsonObj.length();i++){
                            ...
                            GroupCoverMemberAdapterSepMem groupCoverMemberAdapterMEM =
                                    new GroupCoverMemberAdapterSepMem(context, finalGroupCoverMemberList);

                           LinearLayoutManager layoutManagerGroupCoverMemberMEM =
                                   new LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false);
                            holder.member_recycle.setLayoutManager(layoutManagerGroupCoverMemberMEM);

                            holder.member_recycle.setAdapter(groupCoverMemberAdapterMEM);

                            GroupCoverMemberAdapterSepRel groupCoverMemberAdapterREL =
                                    new GroupCoverMemberAdapterSepRel(context, finalGroupCoverMemberList);

                            LinearLayoutManager layoutManagerGroupCoverMemberREL =
                                    new LinearLayoutManager(context, LinearLayoutManager.VERTICAL,
                                            false);

                        holder.relation_recycle.setLayoutManager(layoutManagerGroupCoverMemberREL);

                            holder.relation_recycle.setAdapter(groupCoverMemberAdapterREL);

                            GroupCoverMemberAdapterSepSum groupCoverMemberAdapterSUM = new GroupCoverMemberAdapterSepSum(context, finalGroupCoverMemberList);

                            LinearLayoutManager layoutManagerGroupCoverMemberSUM = new LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false);


                            holder.sum_recycle.setLayoutManager(layoutManagerGroupCoverMemberSUM);

                            holder.sum_recycle.setAdapter(groupCoverMemberAdapterSUM);

                            GroupCoverMemberAdapterSepPrem groupCoverMemberAdapterPREM = new GroupCoverMemberAdapterSepPrem(context, finalGroupCoverMemberList);

                            LinearLayoutManager layoutManagerGroupCoverMemberPREM = new LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false);


                            holder.prem_recycle.setLayoutManager(layoutManagerGroupCoverMemberPREM);

                            holder.prem_recycle.setAdapter(groupCoverMemberAdapterPREM);
...
*/
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        RecyclerView member_recycle,relation_recycle,sum_recycle,prem_recycle,nomineeCoverAdditionalInfo;
        LinearLayout plus;
        ...
        public ViewHolder(final Context context, View itemView) {
            ...
            super(itemView);
            member_recycle= (RecyclerView) itemView.findViewById(R.id.member_recycle);
            relation_recycle= (RecyclerView) itemView.findViewById(R.id.relation_recycle);
            sum_recycle= (RecyclerView) itemView.findViewById(R.id.sum_recycle);
            prem_recycle= (RecyclerView) itemView.findViewById(R.id.prem_recycle);
