...
public class GroupCoverMemberAdapterSepMem extends RecyclerView.Adapter<GroupCoverMemberAdapterSepMem.ViewHolder> {
    ...
    public GroupCoverMemberAdapterSepMem(Context context, List<VoluntaryBenefit> groupCoverMemberLists) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.member_list_summary_mem, parent, false);
