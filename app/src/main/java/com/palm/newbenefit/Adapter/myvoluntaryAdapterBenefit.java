...
public class myvoluntaryAdapterBenefit extends RecyclerView.Adapter<myvoluntaryAdapterBenefit.ViewHolder> {
    Constants con;
    private List<VoluntaryBenefit> mTrain;
    private Context context = null;
    String token,policy_id;
    // Pass in the contact array into the constructor
    public myvoluntaryAdapterBenefit(Context context, List<VoluntaryBenefit> train) {
