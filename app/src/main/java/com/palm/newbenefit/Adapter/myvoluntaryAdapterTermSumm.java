...
public class myvoluntaryAdapterTermSumm extends RecyclerView.Adapter<myvoluntaryAdapterTermSumm.ViewHolder> {
    Constants con;
    ...
    public myvoluntaryAdapterTermSumm(Context context, List<VoluntaryBenefit> train) {
