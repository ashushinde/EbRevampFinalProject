...
public class ContactUsAdapterAdmin extends RecyclerView.Adapter<ContactUsAdapterAdmin.ViewHolder> {
    Constants con;
    private List<ContactUs> mTrain;
    private Context context = null;

    // Pass in the contact array into the constructor
    public ContactUsAdapterAdmin(Context context, List<ContactUs> train) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        String tpa_contact_3=train.getContact_3();
        String tpa_email_2=train.getEmail_2();
        String tpa_email_3=train.getEmail_3();
        ...
        if ((tpa_email_1 != "null" && !tpa_email_1.isEmpty() && !tpa_email_1.equals(""))
            ...
            if((tpa_email_2 != "null" && !tpa_email_1.isEmpty() && !tpa_email_1.equals(""))
                    && (tpa_email_2 != "null" && !tpa_email_2.isEmpty() && !tpa_email_2.equals(""))) {
            ...
            if((tpa_email_3 != "null" && !tpa_email_3.isEmpty() && !tpa_email_3.equals(""))
                    && (tpa_email_3 != "null" && !tpa_email_3.isEmpty() && !tpa_email_3.equals(""))) {


                viewHolder. email_tpa_c.setText(tpa_email_3);
            }else  if((tpa_email_3 != "null" && !tpa_email_3.isEmpty() && !tpa_email_3.equals(""))){

                viewHolder.  email_tpa_c.setText(tpa_email_3);

            }else {
                viewHolder. email_tpa_c.setVisibility(View.GONE);
            }
        ...
        if ((tpa_contact_1 != "null" && !tpa_contact_1.isEmpty() && !tpa_contact_1.equals(""))
            ...
            if((tpa_contact_1 != "null" && !tpa_contact_1.isEmpty() && !tpa_contact_1.equals(""))
                    && (tpa_contact_2 != "null" && !tpa_contact_2.isEmpty() && !tpa_contact_2.equals(""))
            && (tpa_contact_3 != "null" && !tpa_contact_3.isEmpty() && !tpa_contact_3.equals(""))) {


                viewHolder. contact_tpa_c.setText(tpa_contact_3);
            }else  if((tpa_contact_3 != "null" && !tpa_contact_3.isEmpty() && !tpa_contact_3.equals(""))){

                viewHolder. contact_tpa_c.setText(tpa_contact_3);

            }else {
                viewHolder. contact_tpa_c.setVisibility(View.GONE);
            }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView tpa_name_a,contact_tpa_a,contact_tpa_b,email_tpa_a,email_tpa_b,email_tpa_c,
                address_tpa_a,address_tpa_b,tpaname,contact_tpa_c,
                address_tpa_c,admin;
        ...
        public ViewHolder(final Context context, View itemView) {
            ...
            contact_tpa_c=itemView.findViewById(R.id.contact_tpa_c);
            email_tpa_c=itemView.findViewById(R.id.email_tpa_c);
        }
    }
