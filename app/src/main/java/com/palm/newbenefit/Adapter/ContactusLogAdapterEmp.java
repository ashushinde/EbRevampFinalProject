...
public class ContactusLogAdapterEmp extends
        RecyclerView.Adapter<ContactusLogAdapterEmp.ViewHolder> {
Constants con;
    ...
    public ContactusLogAdapterEmp(Context context, List<ContactUsMain> train) {
                    ...
                    try {
                        ...
                        if (status.equalsIgnoreCase("false")) {
                            ...
                            for (int h = 0; h < jsonObja.length(); h++) {
                                ...
                                if("Employer".equalsIgnoreCase(jo_areas.getString("type"))){
