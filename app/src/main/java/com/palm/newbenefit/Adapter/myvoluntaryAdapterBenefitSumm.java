...
public class myvoluntaryAdapterBenefitSumm extends RecyclerView.Adapter<myvoluntaryAdapterBenefitSumm.ViewHolder> {
    Constants con;
    ...
    public myvoluntaryAdapterBenefitSumm(Context context, List<VoluntaryBenefit> train) {
