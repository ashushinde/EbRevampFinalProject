...
import com.palm.newbenefit.Fragment.MemberEnrolledFragmentWith;


public class InrollmentAdapterTabAdapternomwithoutnm extends FragmentStatePagerAdapter {
    int tabCount;


    Bundle bundle;

    public InrollmentAdapterTabAdapternomwithoutnm(FragmentManager fm, int tabCount) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        ...
        switch (position) {
            ...
            case 1:
                MemberEnrolledFragmentWith tab3 = new MemberEnrolledFragmentWith();
                return tab3;
