...
public class ContactusmainAdapter extends
        RecyclerView.Adapter<ContactusmainAdapter.ViewHolder> {
Constants con;
    ...
    public ContactusmainAdapter(Context context, List<ContactUsMain> train) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        Log.d("getMainname",train.getMainname());
                ...
                try {
                    ...
                    try {
                        ...
                        if (status.equalsIgnoreCase("false")) {
                            ...
                            if(train.getMainname().equalsIgnoreCase("Broker")) {
                                brokers = jsonObja.getJSONArray("broker_details");
                            }
                            else   if(train.getMainname().equalsIgnoreCase("Employer")){
                                brokers = jsonObja.getJSONArray("employer_details");
                            }
                            else   if(train.getMainname().equalsIgnoreCase("TPA")){
                                //viewHolder.admin.setVisibility(View.GONE);
                                brokers = jsonObja.getJSONArray("tpa_details");
                            }
                                ...
                                for (int j = 0; j < brokers.length(); j++) {
                                    ...
                                    try {
                                        ...
                                        String emailid1 = jo_area.getString("email_1");
                                        String contactno1 = jo_area.getString("contact_1");
                                        String address1 = jo_area.getString("address_line_1");
                                        String levelcount1;
                                        try{
                                            levelcount1= jo_area.getString("level");
                                        }catch (Exception e){
                                            levelcount1="1";
                                        }
                                        ...
                                        String subname2 = jo_area.getString("name");
                                        String empname2 = jo_area.getString("name");
                                        String emailid2 = jo_area.getString("email_2");
                                        String contactno2 = jo_area.getString("contact_2");
                                        String address2 = jo_area.getString("address_line_2");

                                        String levelcount2;
                                        try{
                                            levelcount2= jo_area.getString("level");
                                        }catch (Exception e){
                                            levelcount2="2";
                                        }

                                        String subname3 = jo_area.getString("name");
                                        String empname3 = jo_area.getString("name");
                                        String emailid3 = jo_area.getString("email_3");
                                        String contactno3 = jo_area.getString("contact_3");
                                        String address3 = jo_area.getString("address_line_3");

                                        String levelcount3;
                                        try{
                                            levelcount3= jo_area.getString("level");
                                        }catch (Exception e){
                                            levelcount3="3";
                                        }
