...
public class myvoluntaryAdapterGroupSumm extends RecyclerView.Adapter<myvoluntaryAdapterGroupSumm.ViewHolder> {
    Constants con;
    ...
    public myvoluntaryAdapterGroupSumm(Context context, List<VoluntaryBenefit> train) {
