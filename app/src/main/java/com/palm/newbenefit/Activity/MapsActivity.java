...
import com.palm.newbenefit.ApiConfig.GetNearbyPlacesData;
...
//        AnalyticsApplication.getInstance().trackEvent("show map Page with nearby hospital", "map  Page Displaying",
//                "map Page Displaying");
        ...
        family_id = intent.getStringExtra("Username");
...
//                Toast.makeText(MapsActivity.this,"lat: "+lati+" , long"+longi , Toast.LENGTH_LONG).show();
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        googlePlacesUrl.append("&key=" + "AIzaSyDS0AViRwO6Nk9dnjCn4SdqHPxDvSE4zMA");
        Log.d("getUrl", googlePlacesUrl.toString());
        return (googlePlacesUrl.toString());
    }
    // @string/google_maps_key
   // AIzaSyDS0AViRwO6Nk9dnjCn4SdqHPxDvSE4zMA
           // AIzaSyBt7_eLLSV66gAbwMPvv8bqp5b9QklPYzc
}