 ...
 */
public class MyIntimateClaimFragment extends Fragment {
    int gg;
    Constants con = null;
    Context context;
    ...
    List<MyHosClaimModel> ob = null;
    MyHosClaimAdapter adapter = null;
    RecyclerView recyclerView = null;
    String emp_id;
    ImageView info_text_GH;
    String claim_reimb_id;
    public MyIntimateClaimFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_my_intimate_claim, container, false);
        con=new Constants();
        ...
        if (isNetworkAvailable()) {
            ...
            ob = new ArrayList<>();
            adapter = new MyHosClaimAdapter(getActivity(), ob);
                        ...
                        try {
                            ...
                            if (statusa.equalsIgnoreCase("false")) {
                                ...
                                for (int j = 0; j < jsonObj.length(); j++) {
                                    ...
                                    ob.add(new MyHosClaimModel(claim_reimb_id, claim_reimb_id, name, created_at, total_claim_amount, type, "", claim_reimb_reason, claim_reimb_id, ""));
