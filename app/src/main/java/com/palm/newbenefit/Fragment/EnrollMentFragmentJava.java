 ...
 */
public class EnrollMentFragmentJava extends Fragment {
                        ...
                        try {
                            ...
                            if(shown.equalsIgnoreCase("all")){
                                ...
                                if(nominne.equalsIgnoreCase("show")){
                                    ...
                                    InrollmentAdapterTabAdapter adapter = new InrollmentAdapterTabAdapter(getFragmentManager(), 7);
                                    ...
                                    editor.putString("is_midterm_enrollement_allowed_for_spouse", "0");
                                    editor.apply();
                                    InrollmentAdapterTabAdapternomwithout adapter = new InrollmentAdapterTabAdapternomwithout(getFragmentManager(), 5);
                                    viewPager.setAdapter(adapter);
                                }
...
try{
    if(shown.equalsIgnoreCase("all")){
        ...
        frag();
                            ...
                            Log.d("exassueerrorenrollment",e.toString());
                            try{
                            ...
                            if(shown.equalsIgnoreCase("all")){
                                ...
                                if(nominne.equalsIgnoreCase("show")){
                                    ...
                                    InrollmentAdapterTabAdapternomwithout adapterx = new InrollmentAdapterTabAdapternomwithout(getFragmentManager(), 5);
                            ...
                            //Adding adapter to pager
                                ...
                                Log.d("errorenrollment",e.toString());
                            }
